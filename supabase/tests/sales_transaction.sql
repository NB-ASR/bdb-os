...
select has_function(
  'public',
  'complete_sale',
  array['uuid','uuid','text','uuid','uuid','jsonb','text','text','uuid','uuid','numeric','timestamp with time zone','text'],
  'trusted Sale completion command exists'
);
select has_function(
  'public',
  'reverse_sale',
  array['uuid','uuid','text','uuid','uuid','text'],
  'trusted Sale reversal command exists'
);

...
as $function$
  ...
  select case
    ...
    when private.has_active_support_session_for_actor(target_workspace_id, target_actor_user_id)
      then target_level = 'view'
...
as $function$
  select
    ...
    private.has_active_support_session(target_workspace_id)
      and not private.has_test_write_support_session(target_workspace_id),

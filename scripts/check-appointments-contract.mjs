...
const statusMigration = await readFile(
  "supabase/release-sources/vanita-integration-20260813/20260729110000_appointment_status_values.sql",
  "utf8",
);
const foundationMigration = await readFile(
  "supabase/release-sources/vanita-integration-20260813/20260729110500_appointment_foundation.sql",
  "utf8",
);
const readHardeningMigration = await readFile(
  "supabase/release-sources/vanita-integration-20260813/20260729111000_appointment_read_hardening.sql",
  "utf8",
);
const indexMigration = await readFile(
  "supabase/release-sources/vanita-integration-20260813/20260729111500_appointment_reference_indexes.sql",
  "utf8",
);

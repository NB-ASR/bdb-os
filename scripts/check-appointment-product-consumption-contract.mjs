...
const migration = await readFile("supabase/release-sources/vanita-integration-20260813/20260729150000_appointment_product_consumption.sql", "utf8");
...
assert.match(inventoryApi, /OWNING_WORKFLOW_SOURCE_TYPES[\s\S]*"appointment_consumption"/i, "Generic manual movements must reserve the Appointment source type.");

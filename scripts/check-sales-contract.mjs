...
const migration = await readFile("supabase/migrations/20260728100000_sales_transaction_foundation.sql", "utf8");
const referenceMigration = await readFile("supabase/migrations/20260728100500_sales_reference_uniqueness.sql", "utf8");
...
for (const statement of [
  ...
  "settlement_status = 'not_recorded'", "platform_support_sessions",

...
const migration = await readFile(
  "supabase/migrations/20260728100000_sales_transaction_foundation.sql",
  "utf8",
);
...
for (const statement of [
  ...
  "inventory_movements_single_sale_line_idx",
  "sale_lines_immutable",
  "sales_immutable_except_reversal",
...
console.log("Sales schema, Inventory orchestration, settlement boundary, offline and UI contracts are internally consistent.");

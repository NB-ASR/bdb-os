...
const schema = await readFile("supabase/migrations/20260731110000_supplier_payables_schema.sql", "utf8");
const views = await readFile("supabase/migrations/20260731110500_supplier_payables_views_security.sql", "utf8");
const posting = await readFile("supabase/migrations/20260731111000_supplier_payables_posting_commands.sql", "utf8");
const settlement = await readFile("supabase/migrations/20260731111500_supplier_payables_settlement_commands.sql", "utf8");
const readBoundary = await readFile("supabase/migrations/20260731112000_supplier_payables_cross_department_read.sql", "utf8");

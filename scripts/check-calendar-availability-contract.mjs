...
const migration = await readFile(
  "supabase/release-sources/vanita-integration-20260813/20260729123000_calendar_availability_foundation.sql",
  "utf8",
);
const roomHardening = await readFile(
  "supabase/release-sources/vanita-integration-20260813/20260729123500_appointment_room_conflict_hardening.sql",
  "utf8",
);
...
assert.doesNotMatch(api, /support_test_write|isSupportSession/);
...
assert.match(page, /Staff-to-Service eligibility is already managed within Calendar/);

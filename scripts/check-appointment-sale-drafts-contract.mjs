...
const migration = await readFile("supabase/migrations/20260729143000_appointment_sale_draft_conversion.sql", "utf8");
...
assert.match(api, /support_test_write/i, "Guarded Founder test-write support is missing.");

...
const [
  ...
  read("supabase/release-sources/vanita-integration-20260813/20260805130000_workspace_operations_settings.sql"),
  read("supabase/release-sources/vanita-integration-20260813/20260805130500_restore_operational_settings.sql"),
  read("supabase/release-sources/vanita-integration-20260813/20260805131000_revoke_anonymous_operational_settings.sql"),
...
assert.match(exportApi, /support_read_only/i, "Read-only access must not export workspace data.");

...
const [architecture, decision, foundation, commands, customer360, api, queue, page, profileApi] = await Promise.all([
  ...
  read("supabase/migrations/20260801132000_unified_communications_foundation.sql"),
  read("supabase/migrations/20260801132500_unified_communications_commands.sql"),
  read("supabase/migrations/20260801133000_unified_communications_customer_360.sql"),
...
assert.match(page, /Founder support is read-only/i, "The UI must preserve Founder support read-only behavior.");

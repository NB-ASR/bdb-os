...
const accounts = await readFile("src/app/accounts/operations/page.tsx", "utf8");
const accountsCss = await readFile("src/app/accounts/operations/accounts.module.css", "utf8");

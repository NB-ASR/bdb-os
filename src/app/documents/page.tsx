...
export default function DocumentsPage() {
  ...
  return (
    <>
      ...
      {supportReadOnly ? <div className="review-callout"><AlertCircle size={19} /><div><strong>Founder support is read-only</strong><p>Use an operational workspace account to upload, link or archive Documents.</p></div></div> : null}

...
export default function SalesPage() {
  ...
  return <>
    ...
    {supportMode ? <div className={styles.supportNotice}><ShoppingBag size={18} /><div><strong>Founder support · Read only</strong><span>Sale completion and reversal remain blocked during the audited support session.</span></div></div> : null}

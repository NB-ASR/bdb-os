...
type Filters = { q: string; status: string; method: string; allocation: string; dateFrom: string; dateTo: string };
const DEFAULT_FILTERS: Filters = { q: "", status: "all", method: "all", allocation: "any", dateFrom: "", dateTo: "" };

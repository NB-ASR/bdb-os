...
export default function InventoryWorkspace() {
  ...
  return (
    <>
      ...
      {supportMode ? <div className={styles.supportNotice}><FileCheck2 size={18} /><div><strong>Founder support · Read only</strong><span>Inventory commands and Purchasing posting are blocked during the audited support session.</span></div></div> : null}

...
export default function CalendarPage() {
  ...
  const [supportReadOnly, setSupportReadOnly] = useState(role === "platform-support");
    ...
    <>
      ...
      {supportReadOnly ? (
        <div className={styles.supportNotice}>
          ...
          <div><strong>Founder support · Read only</strong><span>Appointment changes remain blocked during the audited support session.</span></div>
        </div>
      ) : null}

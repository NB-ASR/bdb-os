      ...
      >
        <div className={styles.formBody}>
          <div className={styles.formGrid}>
            <label>Team member<select disabled defaultValue="owner"><option value="owner">Workspace Owner</option></select></label>

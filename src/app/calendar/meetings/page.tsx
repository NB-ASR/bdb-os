...
const previewMeetings: PreviewMeeting[] = [
  {
    ...
    owner: "Vanita Workspace Owner",
    attendees: 4,
    location: "Treatment room 2",
    linkedRecord: "Operations · Weekly review",
    status: "Scheduled",
  },
  {
    ...
    durationMinutes: 30,
    meetingType: "Client",
    owner: "Maya Camilleri",
    attendees: 2,
    location: "Consultation room",
    linkedRecord: "Customer · Maria Galea",
    status: "Scheduled",
  },
  {
    ...
    linkedRecord: "Supplier · Collis Williams",
    status: "Minutes draft",
  },
  {
    title: "July team retrospective",
    date: "24 Jul 2026",
    time: "17:00",
    durationMinutes: 45,
    meetingType: "Internal",
    ...
    attendees: 5,
    location: "Staff area",
    linkedRecord: "Document · July retrospective",
    status: "Completed",
  },
];
      ...
      {supportMode ? (
        <div className={styles.supportNotice}>
          ...
          <div>
            ...
            <span>Meeting creation and document actions remain blocked during the audited support session.</span>
          </div>
        </div>
      ) : null}
      ...
      >
        <div className={styles.formBody}>
          <div className={styles.formGrid}>
            ...
            <label>Owner<select disabled defaultValue="owner"><option value="owner">Vanita Workspace Owner</option></select></label>
            <label>Date<input disabled type="date" defaultValue="2026-07-28" /></label>

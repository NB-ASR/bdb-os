...
export default function CommunicationsPage() {
  ...
  return (
    <>
      ...
      {supportReadOnly ? <div className="review-callout"><TriangleAlert size={19} /><div><strong>Founder support is read-only</strong><p>Communication commands are disabled unless the guarded integration test-write mode is active.</p></div></div> : null}

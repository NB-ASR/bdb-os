...
export default function ProductSupplierIndexPage() {
  ...
  return (
    <>
      ...
      {supportMode ? <div className={styles.supportNotice}><Link2 size={18} /><div><strong>Founder support · Read only</strong><span>Supplier terms are visible but cannot be changed during this audited session.</span></div></div> : null}

...
export default function BankingPage() {
  ...
  const cloudReadOnly = mode === "cloud";
  ...
  return (
    <>
      ...
      <div className="review-callout"><AlertCircle size={19} /><div><strong>{cloudReadOnly ? "Reconciliation is temporarily read-only" : "Local preview reconciliation"}</strong><p>{cloudReadOnly ? "The atomic finance command is not enabled yet. No transaction or invoice status can be changed from this screen until both records can be committed together safely." : "Preview changes remain local and are not connected to a bank account."}</p></div></div>
